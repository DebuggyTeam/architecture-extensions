...
block_names = [
    "Granite Column", "Diorite Column", "Andesite Column", "Cobbled Deepslate Column", "Polished Deepslate Column",
    "Cobblestone Column", "Sandstone Column", "Red Sandstone Column", "Brick Column", "Mossy Cobblestone Column",
    "Stone Brick Column", "Mossy Stone Brick Column", "Deepslate Brick Column", "Deepslate Tile Column",
